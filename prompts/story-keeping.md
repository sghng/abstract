...
to the current stage, consultations and reports are checked against it, and the
principal investigator hears the story's current truth.
...
What makes the story good is the **story-doctrine** prompt; this file is
keeping, not doctrine. Keep it short (one to two pages), living,
narrative-first, impact-oriented, wiki-linked.
...
Report what strengthens the narrative; flag what weakens it internally under
Known Risks in `story.md` rather than broadcasting it. Raise with the principal
investigator only what is lethal: what any competent reviewer would catch that
invalidates a central claim.
...
1. **Risk**: a known fragility or deliberate omission, who flagged it, and what
   a determined critic would say
